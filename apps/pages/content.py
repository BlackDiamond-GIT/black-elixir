...
BLOG_IMAGES = {
    'koristi-masazu-pro-zdorovi': '/static/img/blog/koristi-masazu-pro-zdorovi.webp',
    'relaks-meditace-masaz': '/static/img/blog/relaks-meditace-masaz.webp',
    'spa-retreat-kompletni-pruvodce': '/static/img/blog/spa-retreat-kompletni-pruvodce.webp',
}

MASSEUSE_IMAGES = {
    'julia': '/static/img/masseuses/julia.webp',
    'diana': '/static/img/masseuses/diana.webp',
    'laura': '/static/img/masseuses/laura.webp',
    'vanessa': '/static/img/masseuses/vanessa.webp',
    'ella': '/static/img/masseuses/ella.webp',
    'mira': '/static/img/masseuses/mira.webp',
}
...
SERVICE_CAPTIONS = {
    'cs': [
        'Ticho, které cítíte.',
        'Teplo a hluboká péče.',
        'Okamžik klidu jen pro vás.',
        'Harmonie těla i mysli.',
        'Sdílený zážitek pokoje.',
    ],
    'en': [
        'Silence you can feel.',
        'Warmth and deep care.',
        'A quiet moment for you.',
        'Harmony of body and mind.',
        'A shared stillness.',
    ],
    'ru': [
        'Тишина, которую ощущаешь.',
        'Тепло и глубокая забота.',
        'Тихий момент для вас.',
