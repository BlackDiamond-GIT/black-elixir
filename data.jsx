...
const SERVICES = [
  {
    id:1, slug:'klasicka-masaz',
    name:{ cs:'Klasická masáž', en:'Classic Massage', ru:'Классический массаж' },
    desc:{ cs:'Tradiční švédská masáž pro uvolnění svalového napětí a celkovou relaxaci celého těla pomocí hladivých a hnětacích hmatů.', en:'Traditional Swedish massage for full-body muscle relief and deep relaxation through long gliding and kneading strokes.', ru:'Традиционный шведский массаж для снятия мышечного напряжения и общей релаксации всего тела.' },
    duration:60, price:1200,
    img:'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&w=600&h=450&q=80',
    alt:'Klasická masáž — Black Elixir Spa Praha',
  },
  {
    id:2, slug:'thajska-masaz',
    name:{ cs:'Thajská masáž', en:'Thai Massage', ru:'Тайский массаж' },
    desc:{ cs:'Tradiční thajská masáž kombinující akupresuru, strečink a energetické linie těla pro hlubokou revitalizaci.', en:'Traditional Thai massage combining acupressure, assisted stretching and energy line work for deep revitalisation.', ru:'Традиционный тайский массаж, сочетающий акупрессуру, стретчинг и работу с энергетическими линиями тела.' },
    duration:90, price:1600,
    img:'https://images.unsplash.com/photo-1519823551278-64ac92734fb1?auto=format&fit=crop&w=600&h=450&q=80',
    alt:'Thajská masáž — Black Elixir Spa Praha',
  },
  {
    id:3, slug:'aromaterapie',
    name:{ cs:'Aromaterapeutická masáž', en:'Aromatherapy Massage', ru:'Ароматерапевтический массаж' },
    desc:{ cs:'Jemná masáž s prémiálními éterickými oleji pro hlubokou relaxaci těla i mysli a harmonizaci nervového systému.', en:'Gentle massage with premium essential oils for deep body-mind relaxation and nervous system balance.', ru:'Нежный массаж с премиальными эфирными маслами для глубокого расслабления тела и разума.' },
    duration:75, price:1400,
  ...
  },
  {
    ...
    alt:'Párová masáž — Black Elixir Spa Praha',
  },
];
